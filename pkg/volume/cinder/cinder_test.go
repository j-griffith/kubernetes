...
func (fake *fakePDManager) Detach(deviceName string, nodeName types.NodeName) error {
	return nil
}

func (fake *fakePDManager) WaitForDetach(devicePath string, timeout time.Duration) error {
	return nil
}

func (fake *fakePDManager) UnmountDevice(deviceMountPath string, mounter mount.Interface) error {
	return nil
}

func (fake *fakePDManager) CreateVolume(provisioner *cinderVolumeProvisioner) (volumeID string, volumeSizeGB int, err error) {
